...
1. Define Version Nema 17 vs Nema 23 : [see FAQ](doc/faq.md)
...
1. Get the right Z-Axis motor mount to print --> depending on the [z-Axis FacePlate](3dprint/FacePlatesDXF) and Motor Version: [Download](3dprint/). For more information about ordering a machined plate see the [offical Homepage](https://threedesign.store/downloads/)
